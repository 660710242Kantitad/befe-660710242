...
func main() {
	// var st Student = Student{ID:"1", Name:"kantitad", Email:"sisawat_k@su.ac.th", Year:4, GPA:3.75}

	// st := Student = Student({ID:"1", Name:"kantitad", Email:"sisawat_k@su.ac.th", Year:4, GPA:3.75})
	
	students := []Student{
		{ID:"1", Name:"kantitad", Email:"sisawat_k@su.ac.th", Year:4, GPA:3.75},
